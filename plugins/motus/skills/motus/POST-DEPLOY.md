...
Base URL: `https://{project-id}.agent.lithosai.cloud`
...
```bash
BASE=https://my-project.agent.lithosai.cloud
# Use API key from `motus whoami` or LITHOSAI_API_KEY env var
...
motus serve health https://my-project.agent.lithosai.cloud

# List all active sessions
motus serve sessions https://my-project.agent.lithosai.cloud

# Get session details
motus serve get https://my-project.agent.lithosai.cloud <session-id>

# Get session details and wait for completion
motus serve get https://my-project.agent.lithosai.cloud <session-id> --wait
```
...
1. Verify DNS resolves: `nslookup {project}.agent.lithosai.cloud`
...
motus serve chat https://my-project.agent.lithosai.cloud "ping"
...
# Cloud
motus serve chat https://my-project.agent.lithosai.cloud "test message"
...
If agent code uses the motus wrapper (`motus.openai_agents`), traces are automatically uploaded to the cloud.
