...
| **SDK compatibility** | Drop-in for [OpenAI Agents SDK](docs/integrations/openai-agents.md), [Anthropic SDK](docs/integrations/anthropic-sdk.md), and [Google ADK](docs/integrations/google-adk.md). Change the import, keep your code. |
